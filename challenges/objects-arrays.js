...
universities.sort((a, b) => a.toUpperCase() > b.toUpperCaseO() ? 1 : a.toUpperCase() < b.toUpperCase() ? -1 : 0);
...
const displayNames = zooAnimals.forEach(index => `Name: ${index.animal_name}, Scientific: ${index.scientific_name}.`);
...
*/
const populationTotal = zooAnimals.reduce((a, b) => a + b.population);
